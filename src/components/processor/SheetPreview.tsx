    ...
    <div className="overflow-auto max-h-[500px]">
      <table className="border-collapse w-full">
        <thead className="sticky top-0 bg-gray-50">
          <tr>
            <th className="w-12 bg-gray-50 border border-gray-300 p-1 text-xs font-medium text-gray-700"></th>
        ...
        <tbody>
          {previewData.map((row, rowIndex) => (
            <tr key={rowIndex}>
              <td className="bg-gray-50 border border-gray-300 p-1 text-xs font-medium text-gray-700 text-center">
                {rowIndex + 1}
              </td>
